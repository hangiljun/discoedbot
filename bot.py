...
AFFILIATE_MESSAGE = (
    "🍁 메이플스토리 디스코드 - 제휴\n\n"
    "💶 MVP 작업 / 매달 이벤트 진행 <#1202611017310277652>\n"
    "🍁 급처 문의 (메소 & 아이템 거래) <#1201063176171683911>\n"
    "✅ 안전거래 사이트 <#1319583564714610708>\n"
    "💻 PC방 대행 (시간 이벤트) <#1202558731930304562>\n"
    "⚔️ 보스 대행 전문팀 <#1412842413977768036>"
)
